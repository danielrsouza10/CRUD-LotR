sap.ui.define(
    ...
    function (opaTest) {
        ...
        opaTest("Deve navegar até a página de notFound", function (Given, When, Then) {
            //Actions
            ...
            // Assertions
            Then.naPaginaDeNotFound
                .oTituloDaPaginaNotFoundDeveraSer();
        });
        opaTest("Na página de notFound devera navegar de volta para Home", function (Given, When, Then) {
            //Actions
