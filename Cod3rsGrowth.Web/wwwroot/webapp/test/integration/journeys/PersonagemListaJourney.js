    ...
    function (opaTest) {
        ...
        opaTest(
            ...
            function (Given, When, Then) {
                ...
                //Actions
                When.naPaginaDaListaDePersonagens.euDigitoONomeDeUmPersonagemNoSearchField("Aragorn");
        ...
        opaTest(
            ...
            function (Given, When, Then) {
                ...
                When.naPaginaDaListaDePersonagens.euPressionoBotaoReset();
                When.naPaginaDaListaDePersonagens.euPressionoBotaoFiltro();
                When.naPaginaDaListaDePersonagens.euSelecionoUmaDataInicial("2012-05-05");
        ...
        opaTest(
            "Deve resetar a lista e navegar de volta para a página Home",
            function (Given, When, Then) {
